            ...
            <form class="d-flex" id="form-gerar">
                <div class="row">
                    ...
                    <div class="col-md-3 mt-5">
                        ...
                        <input type="text" class="form-control required required" placeholder="Ex.: anderson@email.com" name="nome" id="nome">
                    </div>
                    <div class="col-md-3 mt-5">
                        <label class="label-geral" for="nome">Número de registro:*</label>
                        <input type="text" class="form-control required text-capitalize required" placeholder="Ex.: CRP 00/000000 - UF" name="nome" id="nome">
                    </div>
                </div>
            </form>
